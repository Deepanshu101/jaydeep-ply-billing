...
export const invoiceSchema = z.object({
  ...
  dispatch_doc_no: z.string().default(""),
  dispatch_date: z.string().default(""),
  dispatched_through: z.string().default(""),
  destination: z.string().default(""),
  carrier_name: z.string().default(""),
  bill_lading_no: z.string().default(""),
  vehicle_no: z.string().default(""),
  order_no: z.string().default(""),
  order_date: z.string().default(""),
  payment_terms: z.string().default(""),
  other_references: z.string().default(""),
  terms_of_delivery: z.string().default(""),
  gst_percent: z.coerce.number().min(0).max(100),
  discount_type: z.enum(["amount", "percent"]).default("amount"),
  discount_value: z.coerce.number().min(0).default(0),
  terms: z.string().min(1),
